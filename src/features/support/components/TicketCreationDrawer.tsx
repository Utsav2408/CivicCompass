...
export const TicketCreationDrawer = memo(function TicketCreationDrawer({
  isOpen,
  onClose,
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h2 id="drawer-title" style={{ margin: 0, fontSize: "20px" }}>
            {t("support.create.title", "Report an Issue")}
          </h2>
          <button
            type="button"
            onClick={onClose}
        ...
        <div style={{ flex: 1 }}>
          {step === 1 && (
            ...
            >
              ...
              >
                {t("support.create.description_label", "What's the issue?")}
              </label>
              <textarea
                id="description"
                value={description}
              ...
              <label
                ...
                style={{ fontSize: "14px", fontWeight: 600 }}
              >
                {t("support.create.category_label", "Category")}
              </label>
              <select
                id="category"
                value={category}
          ...
          {step === 2 && ticketId && (
            ...
            >
              <label style={{ fontSize: "14px", fontWeight: 600 }}>
                {t("support.create.media_label", "Add Photo/Video (Optional)")}
              </label>
              <MediaUpload
                ticketId={ticketId}
          ...
          {step === 3 && (
            ...
            >
              <label style={{ fontSize: "14px", fontWeight: 600 }}>
                {t("support.create.confirm_label", "Confirm Details")}
              </label>
              <div
                style={{
              ...
              >
                ...
                <p style={{ margin: 0, fontStyle: "italic" }}>
                  User is reporting a {category} issue: "
                  {description.slice(0, 50)}..."
                </p>
              </div>
              {media && (
                <div style={{ fontSize: "12px", color: "var(--gd-dark)" }}>
        ...
        <div style={{ display: "flex", gap: "var(--space-md)" }}>
          ...
          >
            {isSubmitting ? (
              <AshokaCakraLoader size={20} color="white" />
            ) : step === 3 ? (
