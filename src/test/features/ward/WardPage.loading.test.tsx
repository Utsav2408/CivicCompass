...
vi.mock("@/features/ward/hooks/usePartyData", () => ({
  usePartyData: () => ({ parties: [], isLoading: true, error: null }),
}));
...
describe("WardPage loading aggregate branch", () => {
  it("shows top-level loading state when any data source is loading", () => {
    render(<WardPage />);
