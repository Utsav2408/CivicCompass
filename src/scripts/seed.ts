...
const SUPPORT_TICKETS = [
  {
    ...
    description: 'My name does not appear in the final voter roll for Booth 42 in Connaught Place. I have my voter ID card but cannot find my name.',
    category: 'voter-roll',
    status: 'Open',
  ...
  },
  {
    ...
    description: 'The polling booth address shown on NVSP portal does not match the physical location. The school has moved to a new building.',
    category: 'booth',
    status: 'In Progress',
  ...
  },
  {
    ...
    description: 'I submitted a correction request for my voter ID card 3 months ago but have not received the updated card yet.',
    category: 'id-card',
    status: 'Resolved',
  ...
  },
  {
    ...
    description: 'My name was in the draft roll but seems to have been removed from the final Phase 3 voter roll. Voter ID is MH4567890.',
    category: 'voter-roll',
    status: 'Open',
  ...
  },
  {
    ...
    description: 'My elderly mother is 82 years old and needs assistance to vote. She has mobility issues and cannot stand in queue.',
    category: 'other',
    status: 'Resolved',
