...
export function RangoliBorder({
  ...
  if (orientation === 'horizontal') {
    return (
      ...
      >
        ...
        <rect width="100%" height={height} fill={`url(#rangoli-h-${diamondSize})`} />
      </svg>
    )
  }
  ...
  return (
    ...
    >
      ...
      <rect width={height} height="100%" fill={`url(#rangoli-v-${diamondSize})`} />
    </svg>
  )
}
 ...
 */
export function RangoliCardAccent({
  color = 'var(--sf)',
}: {
  color?: string
}) {
